...
public class DartProposalComputer implements ProposalComputer {
	...
	private static Image PROPERTY_ADORNMENT = new Image(DartProposalComputer.class.getClassLoader().getResource("icons/7/property.png").toExternalForm());
	private static Image FIELD_PRIVATE = new Image(DartProposalComputer.class.getClassLoader().getResource("icons/16/field_private_obj.png").toExternalForm());
	private static Image FIELD_PUBLIC = new Image(DartProposalComputer.class.getClassLoader().getResource("icons/16/field_public_obj.png").toExternalForm());
	private static Image METHOD_PRIVATE = new Image(DartProposalComputer.class.getClassLoader().getResource("icons/16/methpri_obj.png").toExternalForm());
	private static Image METHOD_PUBLIC = new Image(DartProposalComputer.class.getClassLoader().getResource("icons/16/methpub_obj.png").toExternalForm());
